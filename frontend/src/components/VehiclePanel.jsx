    ...
    <div>
      ...
      <div onClick={()=>{
        ...
        <div className=" w-1/2">
          ...
          <h5 className="font-medium text-xs text-gray-600">2 mins away</h5>
          <p className="font-normal text-xs text-gray-600">
            Afforfable copact ride
          </p>
        </div>
      ...
      <div onClick={()=>{
        ...
        <div className="-ml-2 w-1/2">
          ...
          <h5 className="font-medium text-xs text-gray-600">3 mins away</h5>
          <p className="font-normal text-xs text-gray-600">
            Afforfable Motorcycle ride
          </p>
        </div>
